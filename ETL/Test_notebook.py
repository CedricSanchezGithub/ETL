...
class GetImageInfoTest(unittest.TestCase):
    ...
    def test_dossier_inexistant_retourne_valeurs_par_defaut(
        self, mock_image_open, mock_listdir, mock_exists
    ):
    ...
    @patch("PIL.Image.open")
    @patch("os.path.join")
    def test_calcul_correct_avec_une_seule_image(
        self, mock_join, mock_image_open, mock_listdir, mock_exists
    ):
        mock_exists.return_value = True
    ...
    @patch("PIL.Image.open")
    @patch("os.path.join")
    def test_calcul_moyen_avec_plusieurs_images(
        self, mock_join, mock_image_open, mock_listdir, mock_exists
    ):
        mock_exists.return_value = True
    ...
    @patch("PIL.Image.open")
    @patch("os.path.join")
    def test_gestion_erreurs_lors_ouverture_image(
        self, mock_join, mock_image_open, mock_listdir, mock_exists
    ):
        mock_exists.return_value = True
    ...
    @patch("PIL.Image.open")
    @patch("os.path.join")
    def test_verification_extension_images_case_insensitive(
        self, mock_join, mock_image_open, mock_listdir, mock_exists
    ):
        mock_exists.return_value = True
        mock_listdir.return_value = [
